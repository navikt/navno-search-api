...
fun SearchPage<Content>.toDecoratorSearchResult(params: Params): DecoratorSearchResult =
    DecoratorSearchResult(
        ...
        word = params.ord,
        total = totalElements,
        hits = searchHits.searchHits.map { it.toDecoratorHit(params.ord.isInQuotes()) },
    )

private fun SearchHit<Content>.toDecoratorHit(isMatchPhraseQuery: Boolean): DecoratorSearchHit =
    DecoratorSearchHit(
